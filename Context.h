 ...
 * un champ de force, des contraintes statiques, une hauteur et une largeur de l'environnement.
...
public:
     ...
     */
    Context(){particles={},colliders={},champ_de_force={0,0},S_Constraints={},width=0,height=0;}
